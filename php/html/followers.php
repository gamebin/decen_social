...
<head>
  ...
  <title>팔로워 - Linking: Decentralized Social Networking</title>
  ...
  <main role="main" class="container">
    ...
    <div class="row mt-3 mt-lg-5">
      ...
      <div class="col-12">
        ...
        <h5>팔로워 <span class="badge badge-primary badge-pill"><?=$totcnt?></span></h5>
		<div id="pro_con01">
<!-- Ajax 내용 보이기 -->
		</div>
...
function load_cont(){
	$("#cur_page").val(2);
	$.ajax({
        url: './followers_Ajax.php?callback=?',
        type: 'POST',
		data: {
		  "cur_page": 1,
       },
